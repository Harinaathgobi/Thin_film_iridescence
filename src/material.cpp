...
struct eval_op {
    ...
    Spectrum operator()(const ThinFilmIridescence& bsdf) const;
...
struct pdf_sample_bsdf_op {
    ...
    Real operator()(const ThinFilmIridescence& bsdf) const;
...
struct sample_bsdf_op {
    ...
    std::optional<BSDFSampleRecord> operator()(const ThinFilmIridescence& bsdf) const;
...
struct get_texture_op {
    ...
    TextureSpectrum operator()(const ThinFilmIridescence& bsdf) const;
...
#include "materials/thin_film_iridescence.inl"
