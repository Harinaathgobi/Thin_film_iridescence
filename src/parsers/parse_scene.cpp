...
///
    ...
    for (auto child : node.children()) {
        ...
        if (name == "baseColor" || name == "base_color") {
            ...
            eta1 = parse_float(child.attribute("value").value(), default_map);
        }
        else if (name == "eta2") {
        ...
        else if (name == "filmheight") {
            filmheight = parse_float(child.attribute("value").value(), default_map);
        }
        else if (name == "filmEta") {
